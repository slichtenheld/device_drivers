...
Copy the files char_driver.c(your driver file), Makefile and userapp.c to a virtual linux machine
...
3) Test driver :
	...
	Note : userapp has to be executed with root privilege as the device files
		   in /dev/ are created in the driver with root privileges.
		   
4) Unload module : $ sudo rmmod char_driver.ko
